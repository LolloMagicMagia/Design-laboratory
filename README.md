...
```
cd existing_repo
git remote add origin https://gitlab.com/ElioGargiulo/bicochat.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/ElioGargiulo/bicochat/-/settings/integrations)
